...
public class RecipeServiceIT {
    ...
    // use public static final for any values that we'll be testing against
    // static final variables are named using the ALL_CAPS_WITH_UNDERSCORES convention
    ...
    public void testSaveOfDescription() throws Exception {
        ...
        // in this case, the finalAll() method will iterate and return a list of Recipe objects
