...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    // @Transactional in this instance is used to place the method within the Transactional context of the onApplicationEvent method.
    // fixes an error
    @Override
    @Transactional
    ...
    private List<Recipe> getRecipes() {
        ...
        log.debug("##### Adding Categories for Recipes #####");
        ...
        log.debug("##### Adding Yummy Guac Recipe #####");
        ...
        log.debug("##### Adding Yummy Guac Ingredients #####");
        ...
        log.debug("##### Adding Yummy Tacos Recipe #####");
        ...
        log.debug("##### Adding Yummy Tacos Ingredients #####");
